...
const Hero = () => {
  return (
    <div className='relative'>
        <section className="hero-section bg-secondary  flex flex-col px-16 py-8  lg:flex-row">
            <div className="mt-10 lg:w-1/2">
                ...
                <div className="lg:mt-4 ">
                    <button className='px-5 md:px-6 mx-auto lg:mx-0 gap-3 py-3 md:py-4 flex text-lg md:text-xl text-primary rounded-lg font-medium bg-text-color'>Download <span className='text-primary text-sm md:text-base self-center'><FaArrowRightLong/></span></button>
                </div>
