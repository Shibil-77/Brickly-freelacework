            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  <strong>Company location :</strong> PM Arcade Melmuri, PO,
                  Alathurpedi, Malappuram, Kerala 676517
                  <br />
                  Support @brickly. Ai
                </p>
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  DataHQ
                  Q1 Mall, Palarivattom, Kochi, Kerala 682028
                </p>
              ...
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  ...
                  >
                    <img
                      className="w-5 h-5"
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpAlIHViSx0vpXvEx9I5NLTyah_22dZwDpsw&usqp=CAU"
                      alt=""
                    />
                  </a>
                </div>
...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-base leading-loose text-body-color hover:text-text-color dark:text-dark-6"
      >
        {label}
      </a>
    </li>
